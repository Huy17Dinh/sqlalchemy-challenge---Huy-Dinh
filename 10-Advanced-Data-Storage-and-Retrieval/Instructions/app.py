...
def home():
    return (f"Welcome to Surf's Up!:<br/>"
            ...
            f"For a list of all stations weather observation<br/>"
            f"/api/v1.0/stations<br/>"
            f"<br/>"
            f"For the latest year of preceipitation data<br/>"
            f"/api/v1.0/precipitations<br/>"
            f"<br/>"
            f"For the latest year of temperature data<br/>"
            f"/api/v1.0/tobs<br/>"
            f"<br/>"
            f"For datesearch (yyyy-mm-dd)<br/>"
